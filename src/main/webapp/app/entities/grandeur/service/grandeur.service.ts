...
const apikey='coinranking2dcb3d88b7c8a64483eb13bcfc4be95c667b50625fd66503'
...
export class GrandeurService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/grandeur');
  protected apiUrl = 'https://api.coinranking.com/v2/coins';
  private proxyUrl = 'https://cors-anywhere.herokuapp.com/';
  constructor(protected http: HttpClient, protected applicationConfigService: ApplicationConfigService) {}
  cryptoData() :any{
    const url = `${this.proxyUrl}${this.apiUrl}`

    return this.http.get(url, httpOptions).toPromise().then((data)=>(data))
 }
